  ...
  return (
    ...
    >
      ...
      <AwardWrapper height='auto'>
        <MediumHeadLine fontSize="4rem" color='blue' mediaFontSize='4rem' >7,000₪</MediumHeadLine>
      ...
      <AwardWrapper height='auto'>
        <MediumHeadLine fontSize="4rem" color='blue' mediaFontSize='4rem' >4,000₪</MediumHeadLine>
        <SplitLogo height='4rem' src={split} />
        <BigHeadLine mediaFontSize='6rem' color='pink'> 2 </BigHeadLine>
        <SplitLogo heightMobile='6rem' marginLeft='1.5rem' height='10rem' src={coins2} />
      </AwardWrapper>
      <AwardWrapper height='auto'>
        <MediumHeadLine fontSize="4rem" mediaFontSize='4rem' color='blue'>2,000₪</MediumHeadLine>
        <SplitLogo height='4rem' src={split} />
