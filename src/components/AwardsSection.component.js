...
import { FlexWrapper, BigHeadLine, Text, SplitLogo } from "../utils/constants/styledComponentsGlobal.constant";
import split from "../assets/split.png";

function AwardsSection() {
    return (
        <FlexWrapper flexDirection='column' height='100vh' backgroundColor='darkPurpel'>
