...
import { BigHeadLine, FlexWrapper, Space, Text } from "../utils/constants/styledComponentsGlobal.constant";
import CountDownTimer from "./CountDownTimer.component";

function Header() {
    return (
        <FlexWrapper flexDirection='column' backgroundColor='darkPurpel' height='100vh'>
